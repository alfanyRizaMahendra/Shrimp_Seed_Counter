...
class Page1(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button3 = buttonL(self,[16,2],[710,440],"Record",fontStyle,18,[BlackSolid,_from_rgb((255,190,100))],lambda : [self.startRecord()])
        button3.buttonShow()
    ...
    def startRecord(self, event = None):
        self.count += 1
        videoStream.onStart(self.videoObj, bgColor = self.backColor, recordCount = self.count, recordTime = 2, record = "yes")
